...
def recommend_stocks():
    try:
        burray = Burray()  # Initialize Burray class
        burray.run()  # Run Burray methods
        return jsonify({
            'status': 'Recommendation complete',
            'max_sharpe': burray.maximum_sharpe_portfolio.to_dict(),
            'min_var': burray.minimum_variance_portfolio.to_dict(),
            'risk_parity': burray.risk_parity_portfolio.to_dict()
        })
